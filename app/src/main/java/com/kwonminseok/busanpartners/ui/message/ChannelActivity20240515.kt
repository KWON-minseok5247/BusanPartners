...
//
//class ChannelActivity20240515 : BaseConnectedActivity() {
...
////                                currentUser = user,
////                                connectionState = listViewModel.connectionState.value,
...
//            Intent(context, ChannelActivity20240515::class.java).putExtra(CID_KEY, channel.cid)
//
...
//            channelType: String,
//            channelId: String,
//        ) = Intent(context, ChannelActivity20240515::class.java).apply {
