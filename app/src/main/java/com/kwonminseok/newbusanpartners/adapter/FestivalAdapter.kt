...
import com.kwonminseok.newbusanpartners.ui.home.Festival

class FestivalAdapter : RecyclerView.Adapter<FestivalAdapter.FestivalViewHolder>() {

    inner class FestivalViewHolder(val binding: ItemEventBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(festival: Festival){
            binding.tvFestivalTitle.text = festival.title
            binding.tvFestivalLocation.text = "${festival.eventstartdate} - ${festival.eventenddate}"
