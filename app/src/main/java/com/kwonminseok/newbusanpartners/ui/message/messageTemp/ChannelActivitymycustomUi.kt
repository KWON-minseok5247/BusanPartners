...
import com.kwonminseok.newbusanpartners.ui.message.BaseConnectedActivity
...
class ChannelActivitymycustomUi : BaseConnectedActivity() {
...
//                MyCustomUi()
    ...
    companion object {
        ...
        fun createIntent(
            ...
            return Intent(context, ChannelActivitymycustomUi::class.java).apply {
