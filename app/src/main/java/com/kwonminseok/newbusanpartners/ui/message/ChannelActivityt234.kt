...
//
//class ChannelActivityt234 : BaseConnectedActivity() {
...
//            Intent(context, ChannelActivityt234::class.java).putExtra(CID_KEY, channel.cid)
//
...
//            channelType: String,
//            channelId: String,
//        ) = Intent(context, ChannelActivityt234::class.java).apply {
